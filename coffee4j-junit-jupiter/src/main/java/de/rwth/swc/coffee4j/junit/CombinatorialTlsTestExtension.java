...
/**
 * This is a modified copy of coffee4j's CombinatorialTestExtension.
 * The extension handling a {@link CombinatorialTlsTest}. Creates one {@link TestTemplateInvocationContext}
 * for each test input.
 * <p>
...
public class CombinatorialTlsTestExtension extends CombinatorialTestExtension {
    ...
    public Stream<TestTemplateInvocationContext> provideTestTemplateInvocationContexts(ExtensionContext extensionContext) {
        ...
        final TlsTestInputIterator iterator = new TlsTestInputIterator(extensionContext);
