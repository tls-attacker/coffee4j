...
/**
 * This is a modified copy of coffee4j's TestInputIterator.
 ...
 */
class TlsTestInputIterator implements Iterator<Combination> {
    ...
    public TlsTestInputIterator(ExtensionContext context) {
